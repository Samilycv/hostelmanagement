...
export class AdminService {
  ...
  girlsSuperDeluxRooms() {
    ...
    (
      ...
      catchError(error => {
        const msg = "Girls Super Delux Room Details not fetch. Please try again";
        return of(msg);
      })
    );
  }
  ...
  girlsDeluxRooms() {
    ...
    (
      ...
      catchError(error => {
        const msg = "Girls Delux Room Details not fetch. Please try again";
        return of(msg);
      })
    );
  }
  ...
  girlsStandardRooms() {
    ...
    (
      ...
      catchError(error => {
        const msg = "Girls Standard Room Details not fetch. Please try again";
        return of(msg);
      })
    );
  }
